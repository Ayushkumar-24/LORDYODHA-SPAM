...
USTAD_PIC = "https://te.legra.ph/file/72b62b91b81e2c1313474.jpg"
...
async def start(event):
    if event.sender_id in SMEX_USERS:
     await idk.send_file(event.chat_id,
                                  USTAD_PIC,
                                  caption="𝐇𝐄𝐘 𝐒𝐏𝐀𝐌𝐌𝐄𝐑🔥\n𝐈 𝐀𝐌 𝐀𝐋𝐈𝐕𝐄🔥\n 𝐊𝐀𝐀𝐋 𝐈𝐙 𝐑𝐄𝐀𝐃𝐘 𝐓𝐎 𝐅𝐔𝐂𝐊 𝐘𝐎𝐔𝐑 𝐇𝐀𝐓𝐄𝐑𝐒🔥\n"                                
                              )
...
𝐂𝐨𝐧𝐠𝐫𝐚𝐭𝐮𝐥𝐚𝐭𝐢𝐨𝐧𝐬 𝐘𝐨𝐮𝐫 𝐊𝐚𝐚𝐥 𝐒𝐩𝐚𝐦 𝐁𝐨𝐭 𝐑𝐞𝐚𝐝𝐲 𝐓𝐨 𝐅𝐮𝐜𝐤 🤤👅"""

print(text)
print("")
print("🙏🔥🔥𝐒𝐌𝐄𝐗 sᴘᴀᴍ ʙᴏᴛ sᴛᴀʀᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʟʏ.🔥🔥🙏")
